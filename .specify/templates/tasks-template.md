...
### Post-ratification / execution checklist

- [ ] Verify tasks map to stories in `spec.md`
- [ ] Run Codacy analysis for edited files
- [ ] Ensure any canonical component names (e.g., GlobalNav) are used consistently in code and docs
